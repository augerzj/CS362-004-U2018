...
int playAdventurer(int currentPlayer, int handPos, int drawntreasure, struct gameState *state)
{
...
int playSteward(int choice1, int choice2, int choice3, int currentPlayer, int handPos, struct gameState *state)
{
  if (choice1 == 1) {
    //+2 cards
    drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      return playAdventurer(currentPlayer, handPos, drawntreasure, state);
    ...
    case feast:
      return playFeast(choice1, currentPlayer, state);
    ...
    case steward:
      return playSteward(choice1, choice2, choice3, currentPlayer, handPos, state);
    ...
    case embargo:
      return playEmbargo(choice1, currentPlayer, handPos, state);
